...
const static uint32_t ENDSTOP_INVERSION			= 0x0003;

// Name of this machine: 32 bytes.
const static uint32_t MACHINE_NAME				= 0x0020;

// Default locations for the axis: 5 x 32 bit = 20 bytes
const static uint32_t AXIS_HOME_POSITIONS		= 0x0060;
