...
#define FLASH_BASE					(0x10001000UL)
#define EEPROM_START_ADDRESS		(FLASH_BASE + 0x00000)
...
#define AXIS_INVERSION			(FLASH_BASE + 0x00008)
...
#define AXIS_HOME_POSITIONS		(FLASH_BASE + 0x00800)
