...
#define USER_FLASH_AREA_START		(0x00001000UL)

#define EEPROM_BASE					(0x10001000UL)
#define EEPROM_START_ADDRESS		(EEPROM_BASE + 0x00000)
...
#define AXIS_INVERSION			(EEPROM_BASE + 0x00008)
...
#define AXIS_HOME_POSITIONS		(EEPROM_BASE + 0x00800)
